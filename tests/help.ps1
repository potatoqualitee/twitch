...
#>
$includedNames = (Get-ChildItem "$PSScriptRoot\..\*\public\*.ps1" -Recurse).BaseName
$commands = Get-Command -Module (Get-Module tvbot, tvclient) -CommandType Cmdlet, Function, Workflow | Where-Object Name -in $includedNames
