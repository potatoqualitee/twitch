#
# Module manifest for module 'tvnotify'
#
...
@{
    ...
    RootModule         = 'tvnotify.psm1'

    # Version number of this module.
    ModuleVersion      = '0.0.4'

    # ID used to uniquely identify this module
    GUID               = '6fd1fbb7-9b77-4053-b9ba-b8e01b19bf9e'
    ...
    Description        = "A notification system for your Twitch channel"
