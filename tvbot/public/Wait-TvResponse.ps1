function Wait-TvResponse {
    ...
    process {
        ...
        # Wait 1 second
        Write-TvSystemMessage -Type Verbose -Message "Sleeping a moment to let the server catch up"
        ...
        Write-TvSystemMessage -Type Verbose -Message "Waiting for input by starting wait loop"
